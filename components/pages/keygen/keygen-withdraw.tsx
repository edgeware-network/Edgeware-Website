  ...
  return (
    <section id="withdraw" className="container mx-auto my-48 max-w-7xl">
      ...
      <p className="my-2 max-w-prose">
        To withdraw from EVM (e.g. Metamask) to Substrate (e.g. polkadot-js), first send EDG to the
        withdraw address corresponding to your polkadot-js address. Then, you must execute an
