...
export default function SocietyPage() {
  ...
  return (
    <>
      <section id="edgeware-edgemonk" className="mt-24 px-4 text-center">
        <h1 className="my-8 text-6xl">EdgeMonk</h1>
