...
const LINKS: Record<string,LinkItem[]> = {
  builders: [
    ...
    {label: 'List your Resume', icon: IconResume, href: 'https://commonwealth.im/edgeware/proposal/discussion/756-job-board'},
    {label: 'Builders Chat', icon: IconChat, href: ''},
  ],
  venture: [
    {label: 'Apply for Funding', icon: IconBank, href: 'https://commonwealth.im/edgeware/treasury'},
    {label: 'Post a Proposal', icon: IconPost, href: 'https://commonwealth.im/edgeware/proposals'},
  ...
  holders: [
    ...
    {label: 'Whitepaper', icon: IconPaper, href: 'https://arena-attachments.s3.amazonaws.com/4643268/c8d128724f36b716660e4bf21823e760.pdf?1563310093'},
    {label: 'Discord', icon: IconDiscord, href: ''},
    {label: 'Collectives', icon: IconBubbles, href: '/collectives'},
  ],
  staking: [
    {label: 'Run a Validator', icon: IconTerminal, href: 'https://docs.edgeware.wiki/quickstart/set-up-a-validator'},
  ...
  other: [
    ...
    {label: 'Video Tutorials', icon: IconYoutube, href: 'https://www.youtube.com/channel/UC7LAzthbMfggA28kE1fihaA'},
  ...
  return (
    <>
      <Section id="intro" width="wide" gap="narrow">
        <H1 size="1" className="text-center">Get Started</H1>

        <LinksList headline="Builders" items={LINKS.builders} highlight />
        <DevBanner headline="Develop Edgeware Core" leadText="Join our core developers to help build the future of Edgeware" href="/jobs"/>
