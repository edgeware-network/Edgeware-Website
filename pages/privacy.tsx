    ...
    <Section id="privacy-policy" width="normal">
      <SimpleText>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Consumer</strong>, for the purpose of the CCPA (California Consumer Privacy
        ...
        <p>
          ...
          in the CCPA. This does not mean that all examples of that category of personal information
        ...
        <ul>
          ...
          <li>
            ...
            analyze the use of our Service, or other third-party vendors that We use to provide the
            Service to You.
          </li>
        </ul>
        ...
        <p>
          ...
          mean that all examples of that category of personal information were in fact disclosed,
        ...
        <p>
          ...
          information by the business to a third party for valuable consideration. This means that
          We may have received some kind of benefit in return for sharing personal Iinformation, but
        ...
        <p>
          ...
          right to opt-out, You (or Your authorized representative) may submit a request to Us by
          contacting Us.
        </p>
        <p>
        ...
        <ul>
          <li>
            <strong>The right to notice.</strong> You have the right to be notified which categories
          ...
          <li>
            <strong>The right to say no to the sale of Personal Data (opt-out).</strong> You have
            the right to direct Us to not sell Your personal information. To submit an opt-out
            request please contact Us.
          </li>
          <li>
            <strong>The right to delete Personal Data.</strong> You have the right to request the
        ...
        <p>
          ...
          be extended once by an additional 45 days when reasonable necessary and with prior notice.
        </p>
        <p>
        ...
        <p>
          ...
          information that is readily useable and should allow You to transmit the information from
  ...
  return {
    props: {
      meta: {
        ...
        description:
          'The terms that govern your use of our site, all associated sites, and our services.',
      },
      layout: {
        simpleLayout: true,
      },
